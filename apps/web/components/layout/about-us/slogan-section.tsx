const SloganSection = () => {
  return (
    <section className="px-5 py-16 flex flex-col md:items-center gap-8 bg-[linear-gradient(130deg,_rgba(21,41,76,0.9)_0%,_rgba(21,41,76,0.6)_100%),linear-gradient(0,rgba(21,41,76,0.5)_0%,rgba(21,41,76,0.5)_100%),url(/images/bg-pattern.png)] bg-cover">

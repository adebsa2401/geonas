...
const HomeBanner = () => {
  return (
    <section className="bg-[linear-gradient(to_right,rgba(21,41,76,0.6)_18%,transparent),url(/images/home-banner.png)] bg-secondary bg-no-repeat bg-cover bg-center relative">
      <div className="px-5 py-20 md:py-44">
        <div className="lg:container mx-auto">
          <div className="space-y-5 max-w-xl">
            <h2
              data-aos="fade-down"
              className="text-5xl md:text-6xl font-bold text-balance text-primary-foreground"
            >
              Professional Land Surveying & Mapping
            </h2>
            <div data-aos="fade-right" className="w-24 h-0.5 bg-primary" />
            <p
              data-aos="fade-up"
              className="font-medium text-lg md:text-xl text-balance text-primary-foreground"
            >
      ...
      <div
        data-aos="fade-up"
        className="md:absolute md:bottom-0 md:right-0 md:left-0 lg:left-1/4 md:translate-y-1/2 flex flex-col md:flex-row max-md:*:not-last:border-b md:*:not-last:border-r"
      >
